                            ...
                            <div style="display: flex;">
                                <div class="title-pro ms-3 w-100">
                                    ...
                                    <span style="float: right;" id="row-total-{{ $cartItem['rowId'] }}">£ {{ $cartItem['rowTotal']}}</span>
                                        <div class="quantity-control input-group" style="margin-top: -40px; justify-content: center; align-items: center;">
                                        ...
                                        <a href="javascript:void(0)" onclick="removeItemCart({{ $cartItem['rowId'] }})" id="remove-{{ $cartItem['rowId'] }}" class="nav-top-svg" style="float: right; color: white; text-decoration: none; display: flex; align-items: center; width: 40px; margin-top: -15px !important;">
                                    ...
                                    <p style="margin-top: -30px; margin-bottom: 5px;">£ {{ $cartItem['productPrice'] }}</p>
